$(function () {
    ...
    $("button[data-liked]").click(function () {
        ...
        $.ajax({
            ...
            } else {                                   // like işlemi başarılıysa
                liked = !liked;                        // likeda tersini ver
                btn.data("liked", liked);
                spanCount.text(data.result);           // like sayısını güncelle

                console.log("like count(after) : " + spanCount.text());


                spanStar.removeClass("glyphicon-star-empty");    // classları temizle
